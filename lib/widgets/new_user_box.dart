                  ...
                  Container(
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Multi(color: Colors.black, subtitle: 'John Maxwel', weight: FontWeight.bold, size: 4),
                          Multi(color: Colors.black, subtitle: 'maxwellaustralia@gmail.com', weight: FontWeight.w500, size: 3),
                          Multi(color: Colors.black, subtitle: '28 November 2023', weight: FontWeight.w500, size: 3),
                        ],
                      ),
                    )
                ],
